                    ...
                    <div class="col-md-6">
                        ...
                        <div class="promotion promotion-lg bg-black-darker">
                            <div class="promotion-image text-right promotion-image-overflow-bottom">
                                <img src="${pageContext.request.contextPath}/assets/img/iphone-se.png" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-blue">
                            <div class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
                                <img src="${pageContext.request.contextPath}/assets/img/apple-watch-sm.png" alt="" />
                            </div>
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image text-center promotion-image-overflow-bottom">
                                <img src="${pageContext.request.contextPath}/assets/img/mac-mini.png" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-right">
                                <img src="${pageContext.request.contextPath}/assets/img/mac-accessories.png" alt="" />
                            </div>
                            <div class="promotion-caption text-center">
                        ...
                        <div class="promotion bg-black">
                            <div class="promotion-image text-right">
                                <img src="${pageContext.request.contextPath}/assets/img/mac-pro.png" alt="" />
                            </div>
                            <div class="promotion-caption promotion-caption-inverse">
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="${pageContext.request.contextPath}/assets/img/samsung-s7-edge.jpg" alt="" />
                                </div>
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/samsung-note5.png" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/zenfone2.png" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/xperia-z.png" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/lumia-532.png" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                ...
                <div class="category-container">
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="${pageContext.request.contextPath}/assets/img/huawei-mediapad.jpg" alt="" />
                                </div>
                                <div class="item-info bottom">
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/galaxy-tab2.png" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/galaxy-taba.png" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/hp-spectrex2.png" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/xperia-z2.png" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="${pageContext.request.contextPath}/assets/img/ipad-air.png" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
